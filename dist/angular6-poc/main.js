...
module.exports = "body {\n  background-color: white;\n}\n\n.add-location {\n  margin-left: 7%;\n}\n\n.btn:hover, .btn-default:hover {\n  border: 1px solid transparent;\n}\n\n@media only screen and (max-width: 992px) {\n  .col-xs-1 {\n    float: none;\n  }\n\n  .add-location {\n    margin-left: 0;\n    padding-left: 0;\n  }\n}\n\n.login-icon {\n  width: 100px;\n  height: 100px;\n}\n\n.data-container {\n padding-left: 50em;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<div>\n  <button (click)=\"startSharing()\"  >Start sharing</button>\n  <br>\n  <button (click)=\"getLink()\" >Get Shared link</button>\n<br>\n  <div class=\"data-container\">\n    <div class=\"row\">\n      <textarea type=\"text\" id=\"form9\" class=\"md-textarea form-control\" mdbInput></textarea>\n      <label for=\"form7\">User 1</label>\n    </div>\n  <br>\n\n    <div class=\"row\">\n      <textarea type=\"text\" id=\"form8\" class=\"md-textarea form-control\" mdbInput></textarea>\n      <label for=\"form8\">User 2</label>\n    </div>\n    <br>\n\n    <div class=\"row\">\n      <textarea type=\"text\" id=\"form9\" class=\"md-textarea form-control\" mdbInput></textarea>\n      <label for=\"form9\">User 3</label>\n    </div>\n    <button (click)=\"showData()\" id=\"show-data-here\">Show Data</button>\n\n    <span *ngIf=\"showThis\" > Show this</span>\n    <br>\n  </div>\n\n\n</div>\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _assets_js_togetherjs_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../assets/js/togetherjs-min.js */ "./src/assets/js/togetherjs-min.js");
/* harmony import */ var _assets_js_togetherjs_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_assets_js_togetherjs_min_js__WEBPACK_IMPORTED_MODULE_1__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChatComponent = /** @class */ (function () {
    ...
    ChatComponent.checkLocalStorageLanguage = function () {
        localStorage.getItem('');
    };
    ChatComponent.prototype.ngOnInit = function () {
    };
    ChatComponent.prototype.showData = function () {
        this.showThis = true;
    };
    ChatComponent.prototype.startSharing = function () {
    ...
    ChatComponent.prototype.getLink = function () {
...
webpackEmptyContext.id = "./src/assets/js sync recursive";

/***/ }),

/***/ "./src/assets/js/togetherjs-min.js":
/*!*****************************************!*\
  !*** ./src/assets/js/togetherjs-min.js ***!
  \*****************************************/
/*! no static exports found */
...
(function () {
  ...
  var min =  false ? undefined : "yes" == "yes";
  ...
  var TogetherJS = window.TogetherJS = function TogetherJS(event) {
    ...
    function callback(session, jquery) {
      ...
      if (! min) {
        TogetherJS.require = undefined;
        TogetherJS._requireObject = __webpack_require__("./src/assets/js sync recursive");
      }
    }
    if (! min) {
      if (true) {
        if (! __webpack_require__("./src/assets/js sync recursive").config) {
          console.warn("The global require (", __webpack_require__("./src/assets/js sync recursive"), ") is not requirejs; please use togetherjs-min.js");
  ...
  if (defaultHubBase == "__" + "hubUrl"+ "__") {
    ...
    defaultHubBase = "https://togetherjs-hub.glitch.me/";
  }
  ...
  TogetherJS.config.on = function loadTogether()  {
    console.log('loading togetherjs data');
  }
...
module.exports = __webpack_require__(/*! /Users/sadeshra/Desktop/cobrowsing-togetherjs/src/main.ts */"./src/main.ts");
